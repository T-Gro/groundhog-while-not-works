...
module ConvergenceLoop =
    ...
    let private buildBriefing config sprintNum dbBriefing allBuckets prevFailure =
        ...
        String.concat "\n" [
            ...
            ""
            "AMBITION LEVEL: A GREAT sprint ports an ENTIRE TS file (1000-3000 lines) into Go."
            "Not 50 lines. Not 200 lines. The WHOLE file, or the whole remaining unported portion."
            "You are the most capable AI model available. ACT LIKE IT."
            ""
            "Read the FULL TS source file(s) for your chunk INTO CONTEXT. All of it. 2000 lines? Read it."
